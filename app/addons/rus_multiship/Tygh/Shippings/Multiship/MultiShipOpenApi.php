...
use Tygh\Shippings\Multiship\Objects\MultiShipObject;
use Tygh\Shippings\Multiship\Objects\MultiShipOrder;
use Tygh\Shippings\Multiship\Objects\MultiShipRequestDeliveryList;
...
class MultiShipOpenApi extends MultiShipObject
{
  public $_data = array();
  public $_result = "";
  public $_error = "";
  ...
  */
  public function searchDeliveryList($request, $deliverypoint = null)
  {
    ...
    if (!$request instanceof MultiShipRequestDeliveryList) {
      $this->_error = MULTISHIP_ERROR_WRONG_PARAM;

      return false;
    }
    if ($deliverypoint != null && !$deliverypoint instanceof MultiShipDeliveryPoint) {
      $this->_error = MULTISHIP_ERROR_WRONG_PARAM;
  ...
  */
  public function getSenderOrderStatuses($order_id)
  {
    $this->_data = array();
  ...
  public function createOrder($order, $recipient, $delivery, $delivery_point)
  {
    ...
    // проверяем входные данные
    if (!$order instanceof MultiShipOrder or !$recipient instanceof MultiShipRecipient or !$delivery instanceof MultiShipDelivery or !$delivery_point instanceof MultiShipDeliveryPoint) {
      $this->_error = MULTISHIP_ERROR_WRONG_PARAM;
  ...
  */
  ...
  @PARAMS:
    ...
    (String) house - дом
  */
  public function getIndex($city, $street, $house)
  {
    $this->_data = array(
      'city' => $city,
      'street' => $street,
