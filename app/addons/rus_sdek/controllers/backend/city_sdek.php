...
if ($mode == 'autocomplete_city') {
    ...
    if (defined('AJAX_REQUEST')) {
        ...
        $data = RusSdek::SdekCityId($location);

        $city_data = array(
            'from_city_id' => $data,
        );

        Registry::get('view')->assign('sdek_new_city_data', $city_data);
        Registry::get('view')->display('addons/rus_sdek/views/shippings/components/services/sdek.tpl');
        exit;
    }
}
