...
//     }
    ...
    $names = array(
        '344' => array('Ракетка' => 'Теннисная ракетка'),
        '345' => array('Ракетка' => 'Теннисная ракетка'),
        '346' => array('Ракетка' => 'Теннисная ракетка'),
        '409' => array('Детская ракетка' => 'Детская теннисная ракетка'),
