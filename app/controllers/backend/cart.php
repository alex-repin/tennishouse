...
if ($mode == 'cart_list') {
    ...
    $_REQUEST['product_type_c'] = (empty($_REQUEST['product_type_c']) && empty($_REQUEST['product_type_w']) && empty($_REQUEST['result_ids'])) ? 'Y' : (!empty($_REQUEST['product_type_c']) ? $_REQUEST['product_type_c'] : false);
