...
<div class="ty-repay" id="elm_payments_list">
    {include file="views/checkout/components/payments/payment_methods.tpl" payment_id=$order_payment_id|default:$order_info.payment_id order_id=$order_info.order_number}
