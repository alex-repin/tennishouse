<div class="ty-orders-detail">
    ...
    {if $order_info}
            ...
            {if $view_only != "Y"}
                <div class="ty-orders__actions">
                    {hook name="orders:details_tools"}
                        ...
                        {include file="buttons/button.tpl" but_role="text" but_text=$print_order but_href="orders.print_invoice?order_id=`$order_info.order_number`" but_meta="cm-new-window ty-btn__text" but_icon="ty-icon-print orders-print__icon"}

                        {*include file="buttons/button.tpl" but_role="text" but_meta="orders-print__pdf ty-btn__text cm-no-ajax" but_text=$print_pdf_order but_href="orders.print_invoice?order_id=`$order_info.order_number`&format=pdf" but_icon="ty-icon-doc-text orders-print__icon"*}
                    {/hook}
        ...
        <div id="content_general" class="{if $selected_section && $selected_section != "general"}hidden{/if}" style="position: relative;">
