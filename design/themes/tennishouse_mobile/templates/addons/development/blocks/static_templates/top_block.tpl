...
<div class="ty-menu-container">
    <a href="{""|fn_url}" title="{$logos.theme.image.alt}"><div class="ty-menu-container__icon"></div></a>
</div>
...
<div class="ty-cart-container">
    <a href="{""|fn_url}" title="{$logos.theme.image.alt}"><div class="ty-cart-container__icon"></div></a>
</div>
{*
