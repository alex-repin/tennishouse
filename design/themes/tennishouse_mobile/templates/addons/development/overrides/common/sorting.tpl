<div class="ty-sort-dropdown">
    <a id="sw_elm_sort_fields" class="ty-sort-dropdown__wrapper cm-combination">{__("sort_by")}<i class="ty-sort-dropdown__icon ty-icon-down-micro"></i></a>
    <ul id="elm_sort_fields" class="ty-sort-dropdown__content cm-popup-box hidden">
        {foreach from=$sorting key="option" item="value"}
            ...
            {foreach from=$sorting_orders item="sort_order"}
                ...
                <li class="{$sort_class} ty-sort-dropdown__content-item {if $search.sort_by == $option && $search.sort_order_rev != $sort_order}ty-sort-dropdown__content-item-active{/if}">
