...
<tr>
    <td valign="top">
        ...
        <tr>
            <td style="font-style: italic;" nowrap>{__("username")}:&nbsp;</td>
            <td >{$user_data.user_login}</td>
        </tr>
        {else}
        <tr>
            <td style="font-style: italic;" nowrap>{__("email")}:&nbsp;</td>
        ...
        {if $send_password || $settings.General.quick_registration == "Y"}
            {if $password}
            <tr>
                <td style="font-style: italic;" nowrap>{__("password")}:&nbsp;</td>
                <td>{$password}</td>
            </tr>
            {/if}
            <tr>
        ...
        {if !"ULTIMATE:FREE"|fn_allowed_for}
            {if $user_data.usergroups}
                ...
                {foreach from=$user_data.usergroups item="user_usergroup"}
                    <tr>
                        <td style="font-style: italic;" nowrap>{$user_usergroup.usergroup}:&nbsp;</td>
