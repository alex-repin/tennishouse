...
<body style="width: 100%; height: 100%; margin: 0 ; padding: 0;">
    <div style="width: {$addons.rus_russianpost.116_list_width}mm; height: {$addons.rus_russianpost.116_list_height}mm;">
        ...
        <span style="position: absolute;height: 5.5mm;width: 116mm;top: 91mm;left: 17mm;font: 10pt 'Arial';">{$data.fiz_addres}</span>
        ...
        <span style="position: absolute; height: 5.5mm; width: 36mm; top: 159mm; left: 22mm; text-align: center; font: 10pt 'Arial';">{if $data.clear_total_cen}{$data.clear_total_cen}{else}б/ц{/if}</span>
        <span style="position: absolute;height: 5.5mm;width: 38mm;top: 159mm;left: 83mm;text-align: center;font: 10pt 'Arial';">{$order_info.total}</span>
