...
<input type="hidden" name="selected_section" value="detailed" />
...
{capture name="tabsbox"}
    ...
    <div id="content_shipping_methods">
        {include file="common/double_selectboxes.tpl"
            first_name="destination_data[shipping_ids]"
            first_data=$destination.shipping_ids
            second_name="all_shipping_methods"
            second_data=$shipping_methods}
    <!--content_shipping_methods--></div>
{/capture}
