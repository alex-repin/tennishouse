    ...
    <div id="content_tab_general">
        ...
        <fieldset>
                ...
                <div class="controls">
                    <select name="shipment_data[shipping_id]" id="shipping_name">
                        {foreach from=$shippings item="shipping"}
                            <option  {if $order_info.shipping.0.shipping_id == $shipping.shipping_id}selected="selected"{/if}  value="{$shipping.shipping_id}">{$shipping.shipping}</option>
                        {/foreach}
                    </select>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    {include file="common/carriers.tpl" id="carrier_key" name="shipment_data[carrier]" carrier=$order_info.shipping.0.module}
                </div>
            </div>
