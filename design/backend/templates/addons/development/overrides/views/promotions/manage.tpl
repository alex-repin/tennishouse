...
<div class="cm-j-tabs cm-track tabs tabs-with-conf">
    <ul class="nav nav-tabs">
        <li id="group_catalog" class="{if 'catalog' == $zone} active extra-tab{/if}">
            <a href="{"promotions.manage?zone=catalog"|fn_url}">{__("catalog_promotions")}</a>
        </li>
        <li id="group_cart" class="{if 'cart' == $zone} active extra-tab{/if}">
            <a href="{"promotions.manage?zone=cart"|fn_url}">{__("cart_promotions")}</a>
        </li>
    </ul>
</div>
