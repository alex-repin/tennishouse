...
<form action="{""|fn_url}" method="post" name="promotion_form" class="promotion form-horizontal form-edit  {if !$allow_save}cm-hide-inputs{/if}" enctype="multipart/form-data" >
...
<fieldset>
    ...
    <div class="control-group" id="player_photo">
        ...
        <div class="controls">
            {include file="common/attach_images.tpl" image_name="promotion_main" image_object_type="promotion" image_pair=$promotion_data.main_pair image_object_id=$id no_thumbnail=true hide_titles=true}
        </div>
    </div>
    ...
    <div class="control-group">
        <label class="control-label" for="elm_promotion_show_on_site">{__("show_on_site")}</label>
        <div class="controls">
        <input type="hidden" name="promotion_data[show_on_site]" value="N" />
        <input type="checkbox" name="promotion_data[show_on_site]" id="elm_promotion_stop" value="Y" {if $promotion_data.show_on_site == "Y"}checked="checked"{/if}/>
        </div>
    </div>
