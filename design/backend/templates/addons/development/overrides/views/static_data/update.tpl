            ...
            <div class="control-group">
                ...
                <div class="controls mixed-controls cm-bs-group">
                    ...
                    {elseif $p.type == "megabox"}
                        ...
                        <div class="cm-bs-container form-inline clearfix">
                            <label class="radio pull-left">
                                <input type="hidden" name="static_data[{$p.name}][P]" value="" />
                                <input type="radio" class="cm-bs-trigger" name="static_data[megabox][type][{$p.name}]" {if $_megabox_values.types.P}checked="checked"{/if} value="P" onclick="Tygh.$('#un_{$id}').prop('disabled', false);">
                                {__("players")}
                            </label>
                        </div>
                        <br />
