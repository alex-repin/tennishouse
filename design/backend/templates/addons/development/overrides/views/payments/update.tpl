...
<div class="cm-tabs-content" id="tabs_content_{$id}">
    ...
    <fieldset>
        ...
        <div class="control-group">
            <label class="control-label" for="elm_payment_website_{$id}">{__("website")}:</label>
            <div class="controls">
                <input id="elm_payment_website_{$id}" type="text" name="payment_data[website]" value="{$payment.website}">
            </div>
        </div>
