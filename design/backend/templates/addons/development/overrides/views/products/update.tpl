            ...
            <div class="product-manage" id="content_detailed"> {* content detailed *}
                ...
                <div id="acc_information" class="collapse in">
                    ...
                    <div class="control-group {$no_hide_input_if_shared_product}">
                        ...
                        <div class="controls">
                            <textarea id="elm_product_short_descr" name="product_data[short_description]" maxlength="170" cols="55" rows="2" class="input-large">{$product_data.short_description}</textarea>
