...
<tr class="cm-row-status-{$product.status|lower} {$hide_inputs_if_shared_product}">
    ...
    <td>
        ...
        <a class="row-status" href="{"products.update?product_id=`$product.product_id`"|fn_url}">{$product.product|truncate:100 nofilter}</a>
