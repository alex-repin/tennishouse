    ...
    <tr>
        ...
        <td>
            ...
            {if $s.options}
                ...
                {foreach $s.options key="option_id" item="variant_id"}
                    {if $product_options.$option_id.option_name && $product_options.$option_id.variants.$variant_id.variant_name}
                        <span style="margin-right: 10px;">{$product_options.$option_id.option_name}: {$product_options.$option_id.variants.$variant_id.variant_name};</span>
                    {/if}
                {/foreach}
                </span>
            {/if}
