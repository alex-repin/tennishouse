...
<div class="cm-tabs-content" id="tabs_content_{$id}">
    ...
    <fieldset>
        ...
        <div class="control-group">
            <label class="control-label" for="elm_feature_note_url_{$id}">{__("note_url")}</label>
            <div class="controls">
            <input type="text" name="feature_data[note_url]" value="{$feature.note_url}" id="elm_feature_note_url_{$id}" /></div>
        </div>
