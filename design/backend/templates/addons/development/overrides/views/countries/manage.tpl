...
<tr>
    ...
    <th>{__("country")}</th>
    <th class="center">{__("currency")}</th>
...
*}
    ...
    <td class="center row-status">
        <input type="text" name="country_data[{$country.code}][currency_code]" size="10" value="{$country.currency_code}" class="input-small input-hidden" /></td>
    <td class="center row-status">
