     ...
     <fieldset>
        ...
        <tr id="extra_option_variants_{$id}_{$num}" class="cm-ex-op hidden">
            <td colspan="7">
                ...
                {if $smarty.request.product_id}
                <div class="control-group cm-non-cb">
                    <span id="on_extra_option_variant_images_{$id}_{$vr.variant_id}" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand cm-combination-options-{$id}"><span class="exicon-expand"></span></span>
                    <span id="off_extra_option_variant_images_{$id}_{$vr.variant_id}" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand hidden cm-combination-options-{$id}"><span class="exicon-collapse"></span> </span>
                    <a id="sw_extra_option_variant_images_{$id}_{$vr.variant_id}" class="cm-combination-options-{$id}">{__("product_images")}</a>
                    <div class="controls">
                    <div id="extra_option_variant_images_{$id}_{$vr.variant_id}" class="cm-ex-op hidden">
                        {if $vr.images}
                            <div class="cm-sortable sortable-box" data-ca-sortable-table="images_links" data-ca-sortable-id-name="pair_id" id="additional_images_{$id}_{$vr.variant_id}">
                                {assign var="new_image_position" value="0"}
                                {foreach from=$vr.images item=pair name="detailed_images"}
                                    <div class="cm-row-item cm-sortable-id-{$pair.pair_id} cm-sortable-box">
                                        ...
                                        <div class="sortable-item">
                                            {include file="common/attach_images.tpl" image_name="variant_additional_`$vr.variant_id`" image_object_type="variant_additional" image_key=$pair.pair_id image_type="Z" image_pair=$pair icon_title=__("additional_thumbnail") detailed_title=__("additional_popup_larger_image") icon_text=__("text_additional_thumbnail") detailed_text=__("text_additional_detailed_image") delete_pair=true no_thumbnail=true}
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                        ...
                        <div id="box_new_image_{$id}_{$vr.variant_id}">
                            <div class="clear cm-row-item">
                                <input type="hidden" name="product_add_additional_variant_image_data[{$id}]{$vr.variant_id}[0][position]" value="{$new_image_position}" class="cm-image-field" />
                                <div class="image-upload-wrap pull-left">{include file="common/attach_images.tpl" image_name="variant_add_additional_`$vr.variant_id`" image_object_type="variant_additional" image_type="Z" icon_title=__("additional_thumbnail") detailed_title=__("additional_popup_larger_image") icon_text=__("text_additional_thumbnail") detailed_text=__("text_additional_detailed_image") no_thumbnail=true}</div>
                                <div class="pull-right">{include file="buttons/multiple_buttons.tpl" item_id="new_image_`$id`_`$vr.variant_id`"}</div>
                            </div>
                        </div>
                    </div>
                    </div>
