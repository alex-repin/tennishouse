...
{if $items}
    <div id="banner_slider_{$block.snapping_id}" class="banners owl-carousel ty-no-swipe cm-banner-carousel" data-slide-speed="{$block.properties.speed|default:400}" data-auto-play="{$block.properties.delay * 1000|default:false}" data-navigation="{$block.properties.navigation}">
