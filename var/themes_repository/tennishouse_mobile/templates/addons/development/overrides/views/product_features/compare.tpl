            ...
            <table class="ty-compare-products">
                <tr>
                    ...
                    <td class="ty-compare-products__product">
                        <div class=""><a href="{"product_features.delete_product?product_id=`$product.product_id`&redirect_url=`$return_current_url`"|fn_url}" class="ty-remove"  title="{__("remove")}"><i class="ty-remove__icon ty-icon-cancel-circle"></i><span class="ty-remove__txt">{__("remove")}</span></a></div>
                        <a href="{"products.view?product_id=`$product.product_id`"|fn_url}">
                            <div class="ty-compare-products__item">
                                <div class="ty-compare-products__img">{include file="common/image.tpl" image_width=$settings.Thumbnails.product_lists_thumbnail_width obj_id=$product.product_id images=$product.main_pair no_ids=true}</div>
                            </div>

                            <div class="ty-compare-products__item">{$product.product nofilter}</div>
...
{capture name="mainbox_title"}{__("comparison_list")}{/capture}