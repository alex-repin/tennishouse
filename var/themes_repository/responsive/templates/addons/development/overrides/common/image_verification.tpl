{if $option|fn_needs_image_verification == true}
    ...
    <div class="captcha ty-control-group">
        ...
        {/if}
            <input class="ty-captcha__input cm-autocomplete-off" type="text" id="verification_answer_{$id}" placeholder="{__("image_verification_label")}" name="verification_answer" value= "" />
