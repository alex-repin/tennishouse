{foreach from=$product_features item="feature"}
    {if $feature.feature_type != "G"}
        ...
        <div class="ty-product-feature__value">
            ...
            {if $feature.value == "Y"}{__("yes")}{else}{__("no")}{/if}
