...
{if $discussion && $discussion.type != "D"}
        {if $object_type == 'P' && !$hide_scrollbar}
            <div class="discussion-block mCustomScrollbar" data-mcs-theme="dark" id="{if $container_id}{$container_id}{else}content_discussion{/if}" style="max-height: 290px;">
        {else}
