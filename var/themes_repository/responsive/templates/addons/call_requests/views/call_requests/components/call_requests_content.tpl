<form name="call_requests_form" id="form_{$id}" action="{""|fn_url}" method="post" class="cm-ajax">
...
<div class="ty-control-group">
    ...
    <input id="call_data_{$id}_name" size="50" class="ty-input-text-full" type="text" name="call_data[name]" value="{$smarty.session.auth.user_data.firstname} {$smarty.session.auth.user_data.lastname}" />
</div>
...
<div class="buttons-container">
    {include file="buttons/button.tpl" but_name="dispatch[call_requests.request]" but_text=__("buy_now_cr") but_role="submit" but_meta="ty-btn__primary ty-btn__big ty-btn cm-dialog-closer" but_onclick="fn_send_call_request(`$product.product_id`);"}
</div>
