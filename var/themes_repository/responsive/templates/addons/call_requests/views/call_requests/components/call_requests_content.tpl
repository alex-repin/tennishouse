...
<div class="buttons-container">
    {include file="buttons/button.tpl" but_text=__("buy_now_cr") but_role="submit" but_meta="ty-btn__primary ty-btn__big ty-btn" but_onclick="fn_send_call_request(`$product.product_id`);"}
</div>
