{if $cart.chosen_shipping.$group_key == $shipping.shipping_id && $shipping.service_code == 'multiship'}
    ...
    <div class="multiship-block clearfix" >
        <div>
            <div>
                <div>
                    <div class="multiship-title">
                        <h4 class="multiship-delivery-name"> {__("multiship_service_delivery")} {$multiship_shipping_select.delivery_name}</h4>
                    </div>

                    <div>
                        <span class="button-submit button-wrap-left">
                            <span class="button-submit button-wrap-right">
                                <input type="submit" name="multiship" id="multiship{$group_key}"
                                    data-mswidget-open
                ...
                <div class="multiship-type float-left">
            ...
            {if $multiship_shipping_select.photo}
                <div class="delivery-photo">
                    <img src="https://multiship.ru/{$multiship_shipping_select.photo}" width="100">
                </div>
            {/if}
            ...
            <div class="multiship-instruction">
